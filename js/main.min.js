var AudioHandler = function() {
        ...
        function i() {
			document.documentElement.addEventListener("mousedown", t);
            A = new Audio, A.setAttribute("src", "res/mp3/" + vSong + ".mp3"), A.setAttribute("controls", "controls"), A.setAttribute("preload", "auto"), A.addEventListener("seeked", o, !0), A.loop = !0, $(A).addClass("audio-elem"), $(A).insertAfter("#controls-header"), $("#preloader").hide(), P = V.createMediaElementSource(A), P.connect(U), P.connect(D), Q = !0, A.play(), BPMHandler.onBPMBeat(), l()
        }
    ...
    UberVizMain = function() {
        function e() {
            return d = !!("ontouchstart" in window), window.location.href.indexOf("mobile") > -1 && (d = !0), a("脺berViz v" + VERSION), $(window).on("resize", i), r() ? (navigator.getUserMedia = navigator.getUserMedia || navigator.webkitGetUserMedia || navigator.mozGetUserMedia || navigator.msGetUserMedia, navigator.getUserMedia ? (document.onselectstart = function() {
                return !1
...
var ColorWheel = function() {
    ...
    Crystal = function() {
        function e() {
			...
			setInterval(function(){ u.on = true;  s.visible = u.on; }, 1);
    ...
    ImageTunnel = function() {
        function e() {
            ...
            t(), n()
			setInterval(function(){ g.on = true; g.opacity = 1; d.visible = g.on; u.opacity = g.opacity }, 1);
        }
